(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.tokenize = function(code, opts) {
      ...
      this.indents = [];
      this.tokens = [];
      this.lineStartIndices = [0].concat((function() {
        var _ref2, _results;
        _results = [];
        for (i = 0, _ref2 = code.length; 0 <= _ref2 ? i < _ref2 : i > _ref2; 0 <= _ref2 ? i++ : i--) {
          if (code.charAt(i) === '\n') {
            _results.push(i + 1);
          }
        }
    ...
    Lexer.prototype.updateColumn = function(i, code) {
      var currentLine, j, len;
      j = 0;
      len = this.lineStartIndices.length;
      while (i >= this.lineStartIndices[j] && j < len) {
        currentLine = this.lineStartIndices[j];
        j++;
      }
      return this.column = i - currentLine;
    };
