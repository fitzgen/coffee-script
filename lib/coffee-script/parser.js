...
var $0 = $$.length - 1;
switch (yystate) {
case 1:return this.$ = new yy.Block(this._$.first_line, this._$.first_column, []);
break;
case 2:return this.$ = $$[$0];
break;
case 3:return this.$ = $$[$0-1];
break;
case 4:this.$ = yy.Block.wrap([$$[$0]], this._$.first_line, this._$.first_column);
break;
...
case 11:this.$ = $$[$0];
break;
case 12:this.$ = new yy.Literal(this._$.first_line, this._$.first_column, $$[$0]);
break;
case 13:this.$ = $$[$0];
break;
case 14:this.$ = $$[$0];
...
case 23:this.$ = $$[$0];
break;
case 24:this.$ = new yy.Block(this._$.first_line, this._$.first_column, []);
break;
case 25:this.$ = $$[$0-1];
break;
case 26:this.$ = new yy.Literal(this._$.first_line, this._$.first_column, $$[$0]);
break;
case 27:this.$ = new yy.Literal(this._$.first_line, this._$.first_column, $$[$0]);
break;
case 28:this.$ = new yy.Literal(this._$.first_line, this._$.first_column, $$[$0]);
break;
case 29:this.$ = $$[$0];
break;
case 30:this.$ = new yy.Literal(this._$.first_line, this._$.first_column, $$[$0]);
break;
case 31:this.$ = new yy.Literal(this._$.first_line, this._$.first_column, $$[$0]);
break;
case 32:this.$ = (function () {
        var val;
        val = new yy.Literal(this._$.first_line, this._$.first_column, $$[$0]);
        if ($$[$0] === 'undefined') {
...
break;
case 33:this.$ = new yy.Assign(this._$.first_line, this._$.first_column, $$[$0-2], $$[$0]);
break;
case 34:this.$ = new yy.Assign(this._$.first_line, this._$.first_column, $$[$0-4], $$[$0-1]);
break;
case 35:this.$ = new yy.Value(this._$.first_line, this._$.first_column, $$[$0]);
break;
case 36:this.$ = new yy.Assign(_$[$0-1].first_line, _$[$0-1].first_column, new yy.Value(_$[$0-2].first_line, _$[$0-2].first_column, $$[$0-2]), $$[$0], 'object');
break;
case 37:this.$ = new yy.Assign(_$[$0-3].first_line, _$[$0-3].first_column, new yy.Value(_$[$0-4].first_line, _$[$0-4].first_column, $$[$0-4]), $$[$0-1], 'object');
break;
case 38:this.$ = $$[$0];
break;
case 39:this.$ = $$[$0];
...
case 41:this.$ = $$[$0];
break;
case 42:this.$ = new yy.Return(_$[$0-1].first_line, _$[$0-1].first_column, $$[$0]);
break;
case 43:this.$ = new yy.Return(_$[$0].first_line, _$[$0].first_column);
break;
case 44:this.$ = new yy.Comment($$[$0]);
break;
case 45:this.$ = new yy.Code(_$[$0-4].first_line, _$[$0-4].first_column, $$[$0-3], $$[$0], $$[$0-1]);
break;
case 46:this.$ = new yy.Code(_$[$0-1].first_line, _$[$0-1].first_column, [], $$[$0], $$[$0-1]);
break;
case 47:this.$ = 'func';
break;
...
break;
case 54:this.$ = new yy.Param(_$[$0].first_line, _$[$0].first_column, $$[$0], void 0, void 0);
break;
case 55:this.$ = new yy.Param(_$[$0-1].first_line, _$[$0-1].first_column, $$[$0-1], null, true);
break;
case 56:this.$ = new yy.Param(_$[$0-2].first_line, _$[$0-2].first_column, $$[$0-2], $$[$0], void 0);
break;
case 57:this.$ = $$[$0];
break;
case 58:this.$ = $$[$0];
...
case 60:this.$ = $$[$0];
break;
case 61:this.$ = new yy.Splat(_$[$0-1].first_line, _$[$0-1].first_column, $$[$0-1]);
break;
case 62:this.$ = new yy.Value(_$[$0].first_line, _$[$0].first_column, $$[$0], void 0, void 0);
break;
case 63:this.$ = $$[$0-1].add($$[$0]);
break;
case 64:this.$ = new yy.Value(_$[$0-1].first_line, _$[$0-1].first_column, $$[$0-1], [$$[$0]], void 0);
break;
case 65:this.$ = $$[$0];
break;
case 66:this.$ = $$[$0];
break;
case 67:this.$ = new yy.Value(_$[$0].first_line, _$[$0].first_column, $$[$0], void 0, void 0);
break;
case 68:this.$ = new yy.Value(_$[$0].first_line, _$[$0].first_column, $$[$0], void 0, void 0);
break;
case 69:this.$ = $$[$0];
break;
case 70:this.$ = new yy.Value(_$[$0].first_line, _$[$0].first_column, $$[$0], void 0, void 0);
break;
case 71:this.$ = new yy.Value(_$[$0].first_line, _$[$0].first_column, $$[$0], void 0, void 0);
break;
case 72:this.$ = new yy.Value(_$[$0].first_line, _$[$0].first_column, $$[$0], void 0, void 0);
break;
case 73:this.$ = $$[$0];
break;
case 74:this.$ = new yy.Access(_$[$0-1].first_line, _$[$0-1].first_column, $$[$0]);
break;
case 75:this.$ = new yy.Access(_$[$0-1].first_line, _$[$0-1].first_column, $$[$0], 'soak');
break;
case 76:this.$ = [new yy.Access(this._$.first_line, this._$.first_column, new yy.Literal(_$[$0-1].first_line, _$[$0-1].first_column, 'prototype')), new yy.Access(_$[$0].first_line, _$[$0].first_column, $$[$0])];
break;
case 77:this.$ = new yy.Access(_$[$0].first_line, _$[$0].first_column, new yy.Literal(_$[$0].first_line, _$[$0].first_column, 'prototype'));
break;
case 78:this.$ = $$[$0];
break;
case 79:this.$ = $$[$0-1];
...
break;
case 81:this.$ = new yy.Index(_$[$0].first_line, _$[$0].first_column, $$[$0]);
break;
case 82:this.$ = new yy.Slice(_$[$0].first_line, _$[$0].first_column, $$[$0]);
break;
case 83:this.$ = new yy.Obj(_$[$0-3].first_line, _$[$0-3].first_column, $$[$0-2], $$[$0-3].generated);
break;
case 84:this.$ = [];
break;
case 85:this.$ = [$$[$0]];
...
break;
case 89:this.$ = new yy.Class(_$[$0].first_line, _$[$0].first_column);
break;
case 90:this.$ = new yy.Class(_$[$0-1].first_line, _$[$0-1].first_column, null, null, $$[$0]);
break;
case 91:this.$ = new yy.Class(_$[$0-2].first_line, _$[$0-2].first_column, null, $$[$0]);
break;
case 92:this.$ = new yy.Class(_$[$0-3].first_line, _$[$0-3].first_column, null, $$[$0-1], $$[$0]);
break;
case 93:this.$ = new yy.Class(_$[$0-1].first_line, _$[$0-1].first_column, $$[$0]);
break;
case 94:this.$ = new yy.Class(_$[$0-2].first_line, _$[$0-2].first_column, $$[$0-1], null, $$[$0]);
break;
case 95:this.$ = new yy.Class(_$[$0-3].first_line, _$[$0-3].first_column, $$[$0-2], $$[$0]);
break;
case 96:this.$ = new yy.Class(_$[$0-4].first_line, _$[$0-4].first_column, $$[$0-3], $$[$0-1], $$[$0]);
break;
case 97:this.$ = new yy.Call(this._$.first_line, this._$.first_column, $$[$0-2], $$[$0], $$[$0-1]);
break;
case 98:this.$ = new yy.Call(this._$.first_line, this._$.first_column, $$[$0-2], $$[$0], $$[$0-1]);
break;
case 99:this.$ = new yy.Call(this._$.first_line, this._$.first_column, 'super', [new yy.Splat(this._$.first_line, this._$.first_column, new yy.Literal(this._$.first_line, this._$.first_column, 'arguments'))]);
break;
case 100:this.$ = new yy.Call(this._$.first_line, this._$.first_column, 'super', $$[$0]);
break;
case 101:this.$ = false;
break;
case 102:this.$ = true;
...
case 104:this.$ = $$[$0-2];
break;
case 105:this.$ = new yy.Value(this._$.first_line, this._$.first_column, new yy.Literal(this._$.first_line, this._$.first_column, 'this'));
break;
case 106:this.$ = new yy.Value(this._$.first_line, this._$.first_column, new yy.Literal(this._$.first_line, this._$.first_column, 'this'));
break;
case 107:this.$ = new yy.Value(this._$.first_line, this._$.first_column, new yy.Literal(_$[$0-1].first_line, _$[$0-1].first_column, 'this'), [new yy.Access(_$[$0].first_line, _$[$0].first_column, $$[$0])], 'this');
break;
case 108:this.$ = new yy.Arr(this._$.first_line, this._$.first_column, []);
break;
case 109:this.$ = new yy.Arr(this._$.first_line, this._$.first_column, $$[$0-2]);
break;
case 110:this.$ = 'inclusive';
break;
case 111:this.$ = 'exclusive';
break;
case 112:this.$ = new yy.Range(this._$.first_line, this._$.first_column, $$[$0-3], $$[$0-1], $$[$0-2]);
break;
case 113:this.$ = new yy.Range(this._$.first_line, this._$.first_column, $$[$0-2], $$[$0], $$[$0-1]);
break;
case 114:this.$ = new yy.Range(this._$.first_line, this._$.first_column, $$[$0-1], null, $$[$0]);
break;
case 115:this.$ = new yy.Range(this._$.first_line, this._$.first_column, null, $$[$0], $$[$0-1]);
break;
case 116:this.$ = [$$[$0]];
break;
...
break;
case 125:this.$ = new yy.Try(this._$.first_line, this._$.first_column, $$[$0]);
break;
case 126:this.$ = new yy.Try(this._$.first_line, this._$.first_column, $$[$0-1], $$[$0][0], $$[$0][1]);
break;
case 127:this.$ = new yy.Try(this._$.first_line, this._$.first_column, $$[$0-2], null, null, $$[$0]);
break;
case 128:this.$ = new yy.Try(this._$.first_line, this._$.first_column, $$[$0-3], $$[$0-2][0], $$[$0-2][1], $$[$0]);
break;
case 129:this.$ = [$$[$0-1], $$[$0]];
break;
case 130:this.$ = new yy.Throw(this._$.first_line, this._$.first_column, $$[$0]);
break;
case 131:this.$ = new yy.Parens(this._$.first_line, this._$.first_column, $$[$0-1]);
break;
case 132:this.$ = new yy.Parens(this._$.first_line, this._$.first_column, $$[$0-2]);
break;
case 133:this.$ = new yy.While(this._$.first_line, this._$.first_column, $$[$0]);
break;
case 134:this.$ = new yy.While(this._$.first_line, this._$.first_column, $$[$0-2], {
          guard: $$[$0]
        });
break;
case 135:this.$ = new yy.While(this._$.first_line, this._$.first_column, $$[$0], {
          invert: true
        });
break;
case 136:this.$ = new yy.While(this._$.first_line, this._$.first_column, $$[$0-2], {
          invert: true,
          guard: $$[$0]
        });
break;
...
break;
case 138:this.$ = $$[$0].addBody(yy.Block.wrap([$$[$0-1]], this._$.first_line, this._$.first_column));
break;
case 139:this.$ = $$[$0].addBody(yy.Block.wrap([$$[$0-1]], this._$.first_line, this._$.first_column));
break;
case 140:this.$ = $$[$0];
break;
case 141:this.$ = new yy.While(this._$.first_line, this._$.first_column, new yy.Literal(this._$.first_line, this._$.first_column, 'true')).addBody($$[$0]);
break;
case 142:this.$ = new yy.While(this._$.first_line, this._$.first_column, new yy.Literal(this._$.first_line, this._$.first_column, 'true')).addBody(yy.Block.wrap([$$[$0]], this._$.first_line, this._$.first_column));
break;
case 143:this.$ = new yy.For(this._$.first_line, this._$.first_column, $$[$0-1], $$[$0]);
break;
case 144:this.$ = new yy.For(this._$.first_line, this._$.first_column, $$[$0-1], $$[$0]);
break;
case 145:this.$ = new yy.For(this._$.first_line, this._$.first_column, $$[$0], $$[$0-1]);
break;
case 146:this.$ = {
          source: new yy.Value(this._$.first_line, this._$.first_column, $$[$0])
        };
break;
...
case 150:this.$ = $$[$0];
break;
case 151:this.$ = new yy.Value(this._$.first_line, this._$.first_column, $$[$0]);
break;
case 152:this.$ = new yy.Value(this._$.first_line, this._$.first_column, $$[$0]);
break;
case 153:this.$ = [$$[$0]];
break;
case 154:this.$ = [$$[$0-2], $$[$0]];
...
break;
case 162:this.$ = new yy.Switch(this._$.first_line, this._$.first_column, $$[$0-3], $$[$0-1]);
break;
case 163:this.$ = new yy.Switch(this._$.first_line, this._$.first_column, $$[$0-5], $$[$0-3], $$[$0-1]);
break;
case 164:this.$ = new yy.Switch(this._$.first_line, this._$.first_column, null, $$[$0-1]);
break;
case 165:this.$ = new yy.Switch(this._$.first_line, this._$.first_column, null, $$[$0-3], $$[$0-1]);
break;
case 166:this.$ = $$[$0];
break;
...
break;
case 170:this.$ = new yy.If(this._$.first_line, this._$.first_column, $$[$0-1], $$[$0], {
          type: $$[$0-2]
        });
break;
case 171:this.$ = $$[$0-4].addElse(new yy.If(this._$.first_line, this._$.first_column, $$[$0-1], $$[$0], {
          type: $$[$0-2]
        }));
break;
case 172:this.$ = $$[$0];
...
break;
case 174:this.$ = new yy.If(this._$.first_line, this._$.first_column, $$[$0], yy.Block.wrap([$$[$0-2]], this._$.first_line, this._$.first_column), {
          type: $$[$0-1],
          statement: true
        });
break;
case 175:this.$ = new yy.If(this._$.first_line, this._$.first_column, $$[$0], yy.Block.wrap([$$[$0-2]], this._$.first_line, this._$.first_column), {
          type: $$[$0-1],
          statement: true
        });
break;
case 176:this.$ = new yy.Op(_$[$0-1].first_line, _$[$0-1].first_column, $$[$0-1], $$[$0]);
break;
case 177:this.$ = new yy.Op(_$[$0-1].first_line, _$[$0-1].first_column, '-', $$[$0]);
break;
case 178:this.$ = new yy.Op(_$[$0-1].first_line, _$[$0-1].first_column, '+', $$[$0]);
break;
case 179:this.$ = new yy.Op(_$[$0-1].first_line, _$[$0-1].first_column, '--', $$[$0]);
break;
case 180:this.$ = new yy.Op(_$[$0-1].first_line, _$[$0-1].first_column, '++', $$[$0]);
break;
case 181:this.$ = new yy.Op(_$[$0].first_line, _$[$0].first_column, '--', $$[$0-1], null, true);
break;
case 182:this.$ = new yy.Op(_$[$0].first_line, _$[$0].first_column, '++', $$[$0-1], null, true);
break;
case 183:this.$ = new yy.Existence(_$[$0].first_line, _$[$0].first_column, $$[$0-1]);
break;
case 184:this.$ = new yy.Op(_$[$0-1].first_line, _$[$0-1].first_column, '+', $$[$0-2], $$[$0]);
break;
case 185:this.$ = new yy.Op(_$[$0-1].first_line, _$[$0-1].first_column, '-', $$[$0-2], $$[$0]);
break;
case 186:this.$ = new yy.Op(_$[$0-1].first_line, _$[$0-1].first_column, $$[$0-1], $$[$0-2], $$[$0]);
break;
case 187:this.$ = new yy.Op(_$[$0-1].first_line, _$[$0-1].first_column, $$[$0-1], $$[$0-2], $$[$0]);
break;
case 188:this.$ = new yy.Op(_$[$0-1].first_line, _$[$0-1].first_column, $$[$0-1], $$[$0-2], $$[$0]);
break;
case 189:this.$ = new yy.Op(_$[$0-1].first_line, _$[$0-1].first_column, $$[$0-1], $$[$0-2], $$[$0]);
break;
case 190:this.$ = (function () {
        if ($$[$0-1].charAt(0) === '!') {
          return new yy.Op(_$[$0-1].first_line, _$[$0-1].first_column, $$[$0-1].slice(1), $$[$0-2], $$[$0]).invert();
        } else {
          return new yy.Op(_$[$0-1].first_line, _$[$0-1].first_column, $$[$0-1], $$[$0-2], $$[$0]);
        }
      }.call(this));
break;
case 191:this.$ = new yy.Assign(_$[$0-1].first_line, _$[$0-1].first_column, $$[$0-2], $$[$0], $$[$0-1]);
break;
case 192:this.$ = new yy.Assign(_$[$0-3].first_line, _$[$0-3].first_column, $$[$0-4], $$[$0-1], $$[$0-3]);
break;
case 193:this.$ = new yy.Extends(_$[$0-1].first_line, _$[$0-1].first_column, $$[$0-2], $$[$0]);
break;
}
},
